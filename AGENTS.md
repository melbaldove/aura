...
- **Tool** — primitive operation the LLM can call. 27 built-in tools (filesystem, Discord, skills, memory, tracking, cognitive feedback, search, web, schedules, shell, browser, attachments, vision, events).
...
- 27 built-in tools defined in `brain_tools.gleam:make_built_in_tools()`
