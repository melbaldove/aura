...
- **Self-diagnosis** — ships with man pages plus live cognitive smoke/eval/replay, correction labels, patch proposal reports, delivery probe, digest flush, and delivery dead-letter retry commands. The brain reads them via the shell tool when it needs to understand its own behavior.
