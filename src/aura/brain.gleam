...
pub fn build_system_prompt(
  ...
  <> "\nAfter completing significant work (ACP session, ticket triage, investigation), update both state (what changed) and memory (what was learned)."
  <> "\nDo NOT save to state: completed-work logs, temporary TODO items. Do NOT save to memory: task progress, session outcomes, trivial or easily re-discovered facts."
  <> "\n\nSkills guidance:"
