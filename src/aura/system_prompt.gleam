...
pub fn build_system_prompt(
  ...
  <> "\nFor colloquial references to prior proactive output, use search_events with concrete content words from the user's message to resolve the recent external event, then call record_cognitive_feedback."
