...
pub fn buffer_agent_text_test() {
  let chunk1 = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"Hello \"}}}}"
  let chunk2 = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"world\"}}}}"
  let buf = transport.new_completion_buffer()
...
pub fn buffer_agent_text_resets_on_tool_call_test() {
  let chunk1 = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"First message\"}}}}"
  let chunk2 = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"Second message\"}}}}"
  let buf = transport.new_completion_buffer()
  let buf = transport.buffer_event(buf, "agent_message_chunk", chunk1)
  let buf = transport.buffer_event(buf, "tool_call", "{\"toolName\":\"Read\"}")
  let buf = transport.buffer_event(buf, "agent_message_chunk", chunk2)
...
pub fn format_result_text_test() {
  let chunk = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"The feature is built but not enforced.\"}}}}"
  let buf = transport.new_completion_buffer()
  let buf = transport.buffer_event(buf, "tool_call", "{\"toolName\":\"Read\"}")
...
pub fn format_result_text_empty_summary_test() {
  let chunk = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"x\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"Done.\"}}}}"
  let buf = transport.new_completion_buffer()
  let buf = transport.buffer_event(buf, "agent_message_chunk", chunk)
...
pub fn extract_agent_text_test() {
  let json = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"abc\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"Hello world\"}}}}"
  transport.extract_agent_text(json) |> should.equal("Hello world")
}

pub fn extract_agent_text_with_newlines_test() {
  let json = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"abc\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"line1\\nline2\"}}}}"
  transport.extract_agent_text(json) |> should.equal("line1\nline2")
}

pub fn extract_agent_text_empty_test() {
  let json = "{\"jsonrpc\":\"2.0\",\"method\":\"session/update\",\"params\":{\"sessionId\":\"abc\",\"update\":{\"sessionUpdate\":\"agent_message_chunk\",\"content\":{\"type\":\"text\",\"text\":\"\"}}}}"
