...
pub fn production_llm_client_destructures_with_all_fields_test() {
  // If this compiles and runs, the record has exactly three function fields.
  ...
  case llm_client.production() {
    llm_client.LLMClient(stream_with_tools: _, chat: _, chat_text: _) -> Nil
  }
}
