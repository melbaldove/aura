...
pub fn tier1_paths_test() {
  tier.for_path("workstreams/cm2/logs/2026-03-30.jsonl") |> should.equal(tier.Autonomous)
  tier.for_path("workstreams/cm2/anchors.jsonl") |> should.equal(tier.Autonomous)
...
pub fn tier2_paths_test() {
  tier.for_path("workstreams/cm2/config.toml") |> should.equal(tier.NeedsApproval)
...
pub fn can_write_test() {
  tier.can_write_without_approval("workstreams/cm2/logs/today.jsonl") |> should.be_true
